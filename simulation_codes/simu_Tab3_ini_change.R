...
for(ini in c(0, -1, 2, 5)){
  starttime <- Sys.time()
  cat(paste0("simu_results/simu_ini_change/re_ini=", ini, "\n"))
  folder_name <- paste0("simu_results/simu_ini_change/re_ini=", ini)
  ...
  save(CIs, file = paste0("simu_results/simu_ini_change/re_ini=", ini, "/CIs.rdata"))
  ...
  save(MISEs, file = paste0("simu_results/simu_ini_change/re_ini=", ini, "/MISES.rdata"))
  ...
  # confidence band
  pdf(paste0("simu_results/simu_ini_change/re_ini=", ini, "/alpha1.pdf"))
  ...
  p2 = data.frame(t = seq(0.1,0.9,0.05), 
                  ...
                  yl = xl[pk+n,],
                  yu = xu[pk+n,])
  pdf(paste0("simu_results/simu_ini_change/re_ini=", ini, "/beta1.pdf"))
  ...
  p1 = data.frame(t = rep(seq(0.1,0.9,0.05),1), 
                  ...
                  yl = c(xl[pk,]),
                  yu = c(xu[pk,]))
  pdf(paste0("simu_results/simu_ini_change/re_ini=", ini, "/gamma1.pdf"))
  ggplot(p1, aes(x = t, y = y)) +
    geom_line(color = "red") +
  ...
  write.csv(runingtime, paste0("simu_results/simu_ini_change/re_ini=", ini, "/time.csv"))
}
