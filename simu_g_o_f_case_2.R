...
# }
# save(es_Ni_list, file = "goodness_of_fit/es_Ni_case_2.rdata")
# re_i <- c()
# for(i in c(1, 25, 51)){
...
save(es_Nj_list, file = "goodness_of_fit/es_Nj_case_2.rdata")
...
# }
# save(es_Ni_homo_list, file = "goodness_of_fit/homo_es_Ni_case_2.rdata")
...
save(es_Nj_homo_list, file = "goodness_of_fit/homo_es_Nj_case_2.rdata")
